...
import {addContact, editContact, deleteContact} from "../../store/actions";
...
class Main extends React.Component {
    ...
    Save(e) {
        ...
        if (findDuplicate > -1 && isNewContact) {
            ...
            isNewContact?this.props.addContact(this.state.contact):this.props.editContact(this.state.contact);
        }
...
export default connect(mapStateToProps, {addContact, editContact, deleteContact})(Main);